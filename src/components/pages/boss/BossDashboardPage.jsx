      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white border border-sand-200 rounded-2xl p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="/boss/tasks" className="text-xs text-blush-500 hover:text-blush-600 font-medium">View all →</a>
          </div>
        ...
        <div className="bg-white border border-sand-200 rounded-2xl p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="/boss/meetings" className="text-xs text-blush-500 hover:text-blush-600 font-medium">View all →</a>
          </div>
      ...
      {teamMembers.length > 0 && (
        <div className="bg-white border border-sand-200 rounded-2xl p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="/boss/team-hours" className="text-xs text-blush-500 hover:text-blush-600 font-medium">Manage →</a>
          </div>
